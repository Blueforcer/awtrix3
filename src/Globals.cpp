...
void loadSettings()
{
    ...
    CALENDAR_HEADER_COLOR = Settings.getUInt("CHCOL", 0xF800);
    CALENDAR_TEXT_COLOR = Settings.getUInt("CTCOL", 0x0000);
    CALENDAR_BODY_COLOR = Settings.getUInt("CBCOL", 0xFFFF);
...
uint16_t CALENDAR_HEADER_COLOR = 0;
uint16_t CALENDAR_TEXT_COLOR = 0;
uint16_t CALENDAR_BODY_COLOR = 0xFFFF;
